...
/**
 * 
 * RegisterUseCase: Caso de uso para registrar un nuevo usuario en el sistema. 
...
public class RegisterUseCaseImpl implements RegisterUseCase {
    ...
    public RegisterUseCaseImpl(UserRepositoryPort userRepository, PasswordEncoderPort passwordEncoder) {
