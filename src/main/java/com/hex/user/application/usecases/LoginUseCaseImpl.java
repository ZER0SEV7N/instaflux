...
/**
 * 
 * LoginUseCaseImpl: Implementación del caso de uso para iniciar sesión de un usuario en el sistema.
...
public class LoginUseCaseImpl implements LoginUseCase {
    ...
    public LoginUseCaseImpl(UserRepositoryPort userRepository, PasswordEncoderPort passwordEncoder, JwtPort jwtPort) {
        ...
        return userRepository.findByEmail(email)
            ...
            .flatMap(user -> {
                ...
                if (passwordEncoder.matches(password, user.password()))
                    ...
                    return Mono.just(jwtPort.generateToken(user));
                else
