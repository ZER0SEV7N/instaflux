//infrastructure/adapters/out/mongo/repository/MongoUserRepository.java
...
/**
 * 
 * MongoUserRepository: Interfaz que define los métodos de acceso a la base de datos MongoDB para la entidad User. 
 ...
 */
public interface MongoUserRepository extends ReactiveMongoRepository<UserEntity, String> {
